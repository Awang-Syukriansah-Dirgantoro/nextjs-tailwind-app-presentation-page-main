      ...
      <header className="grid !min-h-[49rem] bg-gray-900 px-8">
        <div className="container mx-auto mt-32 grid h-full w-full grid-cols-1 place-items-center lg:mt-14 lg:grid-cols-2">
          ...
          {/* <Image
            width={470}
            height={576}
            src="/image/transparent_phone_2_v2.png"
            alt="team work"
            className="object-cover col-span-1 my-20 h-full max-h-[30rem] -translate-y-32 md:max-h-[36rem] lg:my-0 lg:ml-auto lg:max-h-[40rem] lg:translate-y-0"
          /> */}
          <img
            src="/image/iPhone 16 Pro mockup natural titanium.png"
            alt="team work"
            className="object-contain h-[600px] w-full col-span-1 my-20 h-full max-h-[30rem] -translate-y-32 md:max-h-[36rem] lg:my-0 lg:ml-auto lg:max-h-[40rem] lg:translate-y-0"
          />
        </div>
      </header>
